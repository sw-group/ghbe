...
# White Box Testing: Tests that involve knowledge of the internal implementation
class TestElaborateFunctionsWhiteBox(unittest.TestCase):
...
# Black Box Testing: Tests that do not involve knowledge of the internal implementation
class TestElaborateFunctionsBlackBox(unittest.TestCase):
